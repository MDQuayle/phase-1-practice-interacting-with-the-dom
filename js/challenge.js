...
heart.addEventListener("click", function() {
    var a = document.getElementById("counter"),
        ...
        d = void 0;
    if ([].concat(makeArray(c.children)).map(function(a) {
...
pause.addEventListener("click", function() {
    time ? (time = !1, clearInterval(interval), this.innerText = "resume") : (time = !0, interval = timer(), this.innerText = "pause"), [].concat(_toConsumableArray(document.getElementsByTagName("button"))).forEach(function(a) {
        "pause" !== a.id && (a.disabled = !time)
    })
})
